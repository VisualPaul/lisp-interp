...
public:
    ...
    virtual Object *call(Argument &args) = 0;
    virtual std::string getName() = 0;
    void print(std::ostream out) override;
protected:
    void reportTypeError(Aguments &args, int argNumber, std::string expected) {
    ...
    void argumentNumberError(Argument &args, int expected) {
